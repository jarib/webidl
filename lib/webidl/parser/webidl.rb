...
module WebIDL
  ...
  module AttributeOrOperation0
    def ws
      elements[1]
    end

    def StringifierAttributeOrOperation
      elements[2]
    end
  end
  ...
  def _nt_AttributeOrOperation
    ...
    if r2
      ...
      s1 << r3
      if r3
        r4 = _nt_StringifierAttributeOrOperation
        s1 << r4
      end
    end
    if s1.last
      r1 = instantiate_node(SyntaxNode,input, i1...index, s1)
      r1.extend(AttributeOrOperation0)
    else
      @index = i1
      r1 = nil
    end
  ...
  def _nt_Operation
    ...
    i0, s0 = index, []
    r1 = _nt_OmittableSpecials
    s0 << r1
    if r1
      r2 = _nt_ws
      s0 << r2
      if r2
        r3 = _nt_OperationRest
        s0 << r3
      end
    end
    if s0.last
  ...
  def _nt_ExtendedAttributeNamedArgList
    ...
    if s0.last
      r0 = instantiate_node(SyntaxNode,input, i0...index, s0)
      r0.extend(ExtendedAttributeNamedArgList0)
    else
      @index = i0
      r0 = nil
    end
...
class WebIDLParser < Treetop::Runtime::CompiledParser
  include WebIDL
end
